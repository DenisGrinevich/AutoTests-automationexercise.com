...
public class ProductsPage extends BasePage {
    ...
    public List<Product> getProductsAddedToCart() {
        ...
        if (getProductsWebElementsFromProductsPage().get(0) == null)
            throw new IllegalStateException("Нет товаров на странице");

        return getProductsWebElementsFromProductsPage().stream().map(this::parseProductFromProductsPage).toList();
    }
